    ...
    if (data) {
        statistics = (<div>
            <Row>
                <Col>
                    <Card>
                        <Card.Header className="Confirmed" as='h6'>Số Ca Mắc Phải </Card.Header>
                        <Card.Body>
                ...
                <Col>
                    <Card>
                        <Card.Header className="Recovered" as='h6'>Số Ca Khỏi Bệnh </Card.Header>
                        <Card.Body>
                ...
                <Col className='my-2'>
                    <Card>
                        <Card.Header className="Deaths" as='h6'>Số Ca Tử Vong </Card.Header>
                        <Card.Body>
