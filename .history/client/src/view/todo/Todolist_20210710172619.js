...
const Todolist = () => {
    ...
    return (
        <div>
            {body}
            <AddPost />
            <Toast show={show} styles={{ position: 'fixed', top: '20%', left: '20%', right: '10px' }} className={`bg-${type} text-white`} onClose={setShowToast.bind(this, { show: false, message: '', type: null })}>
                <Toast.Body>
